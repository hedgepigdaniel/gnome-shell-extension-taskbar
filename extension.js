...
TaskBar.prototype =
{
    ...
    setSignals: function()
    {
        ...
        this.settingSignals =
        [
            this.settingsListener.connect("changed::panel-size", Lang.bind(this, this.onParamChanged)),
            this.settingsListener.connect("changed::panel-size-bottom", Lang.bind(this, this.onParamChanged)),
            this.settingsListener.connect("changed::tb-icon-size", Lang.bind(this, this.onParamChanged)),
            this.settingsListener.connect("changed::tb-icon-size-bottom", Lang.bind(this, this.onParamChanged)),
            this.settingsListener.connect("changed::tb-label-size", Lang.bind(this, this.onParamChanged)),
            this.settingsListener.connect("changed::tb-label-size-bottom", Lang.bind(this, this.onParamChanged)),
            this.settingsListener.connect("changed::content-size", Lang.bind(this, this.onParamChanged)),
            this.settingsListener.connect("changed::font-size-bottom", Lang.bind(this, this.onParamChanged)),
            this.settingsListener.connect("changed::panel-box", Lang.bind(this, this.onBoxChanged)),
            this.settingsListener.connect("changed::panel-position", Lang.bind(this, this.onParamChanged)),
            this.settingsListener.connect("changed::display-favorites", Lang.bind(this, this.onParamChanged)),
            this.settingsListener.connect("changed::display-showapps-button", Lang.bind(this, this.onParamChanged)),
            this.settingsListener.connect("changed::display-workspace-button", Lang.bind(this, this.onParamChanged)),
            this.settingsListener.connect("changed::workspace-button-index", Lang.bind(this, this.onParamChanged)),
            this.settingsListener.connect("changed::workspace-button-color", Lang.bind(this, this.onParamChanged)),
            this.settingsListener.connect("changed::display-workspace-button-color", Lang.bind(this, this.onParamChanged)),
            this.settingsListener.connect("changed::workspace-button-width", Lang.bind(this, this.onParamChanged)),
            this.settingsListener.connect("changed::display-desktop-button", Lang.bind(this, this.onParamChanged)),
            this.settingsListener.connect("changed::overview", Lang.bind(this, this.setOverview)),
            this.settingsListener.connect("changed::tray-button", Lang.bind(this, this.onParamChanged)),
            this.settingsListener.connect("changed::tray-button-empty", Lang.bind(this, this.onParamChanged)),
            this.settingsListener.connect("changed::desktop-button-icon", Lang.bind(this, this.onParamChanged)),
            this.settingsListener.connect("changed::appview-button-icon", Lang.bind(this, this.onParamChanged)),
            this.settingsListener.connect("changed::tray-button-icon", Lang.bind(this, this.onParamChanged)),
            this.settingsListener.connect("changed::sort-tasks", Lang.bind(this, this.onParamChanged)),
            this.settingsListener.connect("changed::active-task-frame", Lang.bind(this, this.onParamChanged)),
            this.settingsListener.connect("changed::inactive-task-frame", Lang.bind(this, this.onParamChanged)),
            this.settingsListener.connect("changed::active-task-background-color", Lang.bind(this, this.onParamChanged)),
            this.settingsListener.connect("changed::active-task-background-color-set", Lang.bind(this, this.onParamChanged)),
            this.settingsListener.connect("changed::inactive-task-background-color", Lang.bind(this, this.onParamChanged)),
            this.settingsListener.connect("changed::inactive-task-background-color-set", Lang.bind(this, this.onParamChanged)),
            this.settingsListener.connect("changed::tasks-label", Lang.bind(this, this.onParamChanged)),
            this.settingsListener.connect("changed::tasks-label-color", Lang.bind(this, this.onParamChanged)),
            this.settingsListener.connect("changed::display-tasks-label-color", Lang.bind(this, this.onParamChanged)),
            this.settingsListener.connect("changed::inactive-tasks-label-color", Lang.bind(this, this.onParamChanged)),
            this.settingsListener.connect("changed::display-inactive-tasks-label-color", Lang.bind(this, this.onParamChanged)),
            this.settingsListener.connect("changed::tasks-frame-color", Lang.bind(this, this.onParamChanged)),
            this.settingsListener.connect("changed::display-tasks-frame-color", Lang.bind(this, this.onParamChanged)),
            this.settingsListener.connect("changed::inactive-tasks-frame-color", Lang.bind(this, this.onParamChanged)),
            this.settingsListener.connect("changed::display-inactive-tasks-frame-color", Lang.bind(this, this.onParamChanged)),
            this.settingsListener.connect("changed::tasks-width", Lang.bind(this, this.onParamChanged)),
            this.settingsListener.connect("changed::tasks-spaces", Lang.bind(this, this.onParamChanged)),
            this.settingsListener.connect("changed::blink-tasks", Lang.bind(this, this.onParamChanged)),
            this.settingsListener.connect("changed::blacklist-set", Lang.bind(this, this.onParamChanged)),
            this.settingsListener.connect("changed::top-panel-background-color", Lang.bind(this, this.onParamChanged)),
            this.settingsListener.connect("changed::top-panel-background-alpha", Lang.bind(this, this.onParamChanged)),
            this.settingsListener.connect("changed::bottom-panel-background-color", Lang.bind(this, this.onParamChanged)),
            this.settingsListener.connect("changed::display-tasks", Lang.bind(this, this.onParamChanged)),
            this.settingsListener.connect("changed::separator-left-box-main", Lang.bind(this, this.onParamChanged)),
            this.settingsListener.connect("changed::separator-right-box-main", Lang.bind(this, this.onParamChanged)),
            this.settingsListener.connect("changed::separator-left-tasks", Lang.bind(this, this.onParamChanged)),
            this.settingsListener.connect("changed::separator-right-tasks", Lang.bind(this, this.onParamChanged)),
            this.settingsListener.connect("changed::separator-left-desktop", Lang.bind(this, this.onParamChanged)),
            this.settingsListener.connect("changed::separator-right-desktop", Lang.bind(this, this.onParamChanged)),
            this.settingsListener.connect("changed::separator-left-workspaces", Lang.bind(this, this.onParamChanged)),
            this.settingsListener.connect("changed::separator-right-workspaces", Lang.bind(this, this.onParamChanged)),
            this.settingsListener.connect("changed::separator-left-appview", Lang.bind(this, this.onParamChanged)),
            this.settingsListener.connect("changed::separator-right-appview", Lang.bind(this, this.onParamChanged)),
            this.settingsListener.connect("changed::separator-left-favorites", Lang.bind(this, this.onParamChanged)),
            this.settingsListener.connect("changed::separator-right-favorites", Lang.bind(this, this.onParamChanged)),
            this.settingsListener.connect("changed::top-panel", Lang.bind(this, this.displayTopPanel)),
            this.settingsListener.connect("changed::activities-button", Lang.bind(this, this.displayActivities)),
            this.settingsListener.connect("changed::activities-button-color", Lang.bind(this, this.colorActivities)),
            this.settingsListener.connect("changed::hot-corner", Lang.bind(this, this.enableHotCorner)),
            this.settingsListener.connect("changed::application-menu", Lang.bind(this, this.displayApplicationMenu)),
            this.settingsListener.connect("changed::application-menu-color", Lang.bind(this, this.colorApplicationMenu)),
            this.settingsListener.connect("changed::date-menu", Lang.bind(this, this.displayDateMenu)),
            this.settingsListener.connect("changed::date-menu-color", Lang.bind(this, this.colorDateMenu)),
            this.settingsListener.connect("changed::system-menu", Lang.bind(this, this.displaySystemMenu)),
            this.settingsListener.connect("changed::system-menu-color", Lang.bind(this, this.colorSystemMenu)),
            this.settingsListener.connect("changed::dash", Lang.bind(this, this.displayDash)),
            this.settingsListener.connect("changed::workspace-selector", Lang.bind(this, this.displayWorkspaceSelector)),
            this.settingsListener.connect("changed::position-changed", Lang.bind(this, this.appearancePositionChange)),
            this.settingsListener.connect("changed::bottom-panel", Lang.bind(this, this.onParamChanged)),
            this.settingsListener.connect("changed::bottom-panel-vertical", Lang.bind(this, this.onParamChanged)),
            this.settingsListener.connect("changed::position-bottom-box", Lang.bind(this, this.onParamChanged)),
            this.settingsListener.connect("changed::tasks-all-workspaces", Lang.bind(this, this.onParamChanged)),
            this.settingsListener.connect("changed::tasks-container-width-new", Lang.bind(this, this.onParamChanged)),
            this.settingsListener.connect("changed::hover-event", Lang.bind(this, this.hoverEvent)),
            this.settingsListener.connect("changed::blacklist", Lang.bind(this, this.onParamChanged)),
            this.settingsListener.connect("changed::find-apps", Lang.bind(this, this.findApps)),
            this.settingsListener.connect("changed::display-preview-background-color", Lang.bind(this, this.onParamChanged)),
            this.settingsListener.connect("changed::display-preview-label-color", Lang.bind(this, this.onParamChanged)),
            this.settingsListener.connect("changed::export-settings", Lang.bind(this, this.exportSettings)),
            this.settingsListener.connect("changed::import-settings", Lang.bind(this, this.importSettings)),
            this.settingsListener.connect("changed::reset-all", Lang.bind(this, this.resetAll)),
            this.settingsListener.connect("changed::reset-flag", Lang.bind(this, this.onParamChanged))
        ];
    },
